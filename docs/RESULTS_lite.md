...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 服務憑證 | 服務憑證 | 82 | 15 | 60,075 | — | — | 0.6891 | 0.6891 | 1 | 否 |
...
| 服務憑證 | 服務憑證 | 82 | 60,075 | 495.67 | — | 0.0083 | — | 0.6891 | 0.6891 | 否 |
...
**這張圖用計數不用佔比，理由是抑制**：服務憑證的 `request_share` 與
`cost_share` 都被抑制成 NA，而它正是錯位最大的一列。畫佔比的話，要嘛把被
抑制的值畫上去，要嘛把最重要的那一點拿掉。計數不受抑制——計數是事實。
