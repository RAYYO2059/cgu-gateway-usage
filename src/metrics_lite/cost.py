...
@metric(
    ...
    caveat=(
        ...
        "流量的形狀不是某個人的行為。cost_share 與 cost_per_user 列入受抑制"
        "欄位——後者在單人主導的組裡就是在描述那個人的花費。服務憑證雖然"
        "單人佔 68.9%，但登記為非自然人分組，集中度規則不對它生效，"
        "cost_share 照常公布；它的 cost_per_user 是 NA，是因為不在人均母體內。\n"
        "\n"
